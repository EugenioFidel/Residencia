	...
	public void actionPerformed(ActionEvent pulsacion) {
		if (pulsacion.getSource().equals(jbCancelar)) {
			...
			try {
				...
				Persona p = new Persona(jtfLetraCif.getText().toUpperCase().charAt(0), jtfDni.getText().toUpperCase(),
						jtfLetraNif.getText().toUpperCase().charAt(0), jtfNombre.getText().toUpperCase(),
						jtfApellidos.getText().toUpperCase(), jtfSegundoApellido.getText().toUpperCase(),
						formatter.parse(jtfFechaNacimiento.getText()), jtfDomicilio.getText().toUpperCase(),
						jtfLocalidad.getText().toUpperCase(), jtfMunicipio.getText().toUpperCase(),
						jtfCp.getText().toUpperCase(), jtfProvincia.getText().toUpperCase(),
						jtfTelefono.getText().toUpperCase(), jtfTelefonoMovil.getText().toUpperCase(),
